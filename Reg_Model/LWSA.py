...
class LWSA2(nn.Module):
    def __init__(self, config):
        super(LWSA2, self).__init__()
        ...
        self.c1 = Conv3dReLU.Conv3dReLU(config.in_chans, embed_dim // 2, 3, 1, use_batchnorm=False)
        self.c2 = Conv3dReLU.Conv3dReLU(config.in_chans, config.reg_head_chan, 3, 1, use_batchnorm=False)
